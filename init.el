...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flymake company-lsp lsp-ui lsp-mode mozc-popup mozc-im exec-path-from-shell markdown-preview-mode flycheck-phpstan org-pomodoro geben-helm-projectile geben darcula-theme markdown-toc vmd-mode rainbow-delimiters highlight-indent-guides docker mozc tern company-web js-doc add-node-modules-path eslint-fix prettier-js go-mode company-php ac-php dockerfile-mode git-commit yaml-mode yasnippet-snippets helm-c-yasnippet yasnippet web-mode php-mode markdown-mode abyss-theme csv-mode json-mode neotree haskell-mode omnisharp csharp-mode ace-jump-mode undohist point-undo helm-helm-commands helm-pydoc helm-descbinds helm color-moccur company-tern company-jedi company-statistics wgrep undo-tree pymacs popup nxml-mode js2-mode html5-schema flymake-python-pyflakes company)))
 '(prolog-program-name
   (quote
    (((getenv "EPROLOG")
      (eval
